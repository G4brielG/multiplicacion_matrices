...
function CrearFormularios(filA, colA, filB, colB) {
  ...
  let fA = document.createElement('FORM')
  let fB = document.createElement('FORM')
  let A = document.createTextNode('Matriz A')
  let B = document.createTextNode('Matriz B')
  d.setAttribute('id', 'matrices')
  d.setAttribute('align', 'center')
  d.setAttribute(
    'style',
    'width: 50%; height: 100%; float: left; background-color: 66FF66'
  )
  ...
  let otro = document.getElementById('main')
  otro.appendChild(d)
}

function CrearFormRes(filaA, colB) {
  let capa = document.createElement('DIV')
  let fRes = document.createElement('FORM')
  let res = document.createTextNode('Matriz Resultante')
  capa.setAttribute('id', 'resultado')
  capa.setAttribute('align', 'center')
  capa.setAttribute(
    'style',
    'width: 50%; height: 100%; float:right; background-color: 20B2AA'
  )
...
function Borrar() {
  let capa1 = document.getElementById('matrices')
  let capa2 = document.getElementById('resultado')
  let padre1 = capa1.parentNode
  let padre2 = capa2.parentNode
